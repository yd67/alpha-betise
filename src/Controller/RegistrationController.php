...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordEncoderInterface $passwordEncoder, GuardAuthenticatorHandler $guardHandler, Authenticator $authenticator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($form->get('img')->getData() !== null){
                ...
                $user->setImg('logo-profil-default.svg');           
                 }

            // recuperation date creation compte
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('snevy67100@gmail.com', 'alpha-betise'))
                    ->to($user->getEmail())
                    ->subject('veuilllez comfirmer votre adresse mail')
    ...
    public function verifyUserEmail(Request $request): Response
    {
        ...
        $this->addFlash('success', 'la verification de votre adresse mail a bien été pris en compte .');
